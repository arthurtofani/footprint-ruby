...
require 'footprint/utils'
require 'footprint/utils/scoring'
require 'footprint/concerns/time_measured'
...
require 'footprint/callback_events/query_started_event'
require 'footprint/callback_events/query_created_event'
require 'footprint/callback_events/query_performed_event'
require 'footprint/callback_events/digest_hashed_event'
require 'footprint/audio_slicer'
